namespace Yahoo2022DraftOrder
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            foreach (string player in CalculateOrder(ballsPerPlayer))
            {
        ...
        public static List<string> CalculateOrder(Dictionary<string, int> ballsPerPlayer)
        {
